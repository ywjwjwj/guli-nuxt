      ...
      <div>
        <article class="c-v-pic-wrap" style="height: 357px;">
          <section class="p-h-video-box" id="videoPlay">
            <img style="width: 100%;height: 357px;" :src="courseWebVo.cover" :alt="courseWebVo.title" class="dis c-v-pic">
          </section>
        </article>
          ...
          <section class="ml20 mr15">
            ...
            <section class="c-attr-mt of">
              <span class="ml10 vam">
                ...
                <a class="c-fff vam" title="点赞" href="#" >点赞</a>
              </span>
            </section>
            <section class="c-attr-mt">
              <a href="#" title="立即观看" class="comm-btn c-btn-3" v-if="isBuyCourse || Number(courseWebVo.price)===0" >立即观看</a>
